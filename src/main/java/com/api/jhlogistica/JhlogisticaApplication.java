...
public class JhlogisticaApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Transport transport = new Transport(null, LocalDate.now(), 12458, "Vargem Grande do Sul - SP", "Guarapuava - PR", new BigDecimal(15000.98), truck, Status.CONCLUDED);
		
		Transport transport1 = new Transport(null, LocalDate.of(2022, 05, 21), 12458, "Vargem Grande do Sul - SP", "Curitiba - PR", new BigDecimal(32000.98), truck, Status.CONCLUDED);
		Transport transport2 = new Transport(null, LocalDate.of(2022, 05, 15), 12458, "Itu - SP", "Parana - PR", new BigDecimal(25000.45), truck, Status.CONCLUDED);
		Transport transport3 = new Transport(null, LocalDate.of(2022, 03, 27), 12458, "São Paulo - SP", "Belo Horizonte - MG", new BigDecimal(13000.58), truck, Status.CONCLUDED);
		Transport transport4 = new Transport(null, LocalDate.of(2022, 04, 8), 12458, "Guarapuava - PR", "Vargem Grande do Sul - SP", new BigDecimal(32300.08), truck, Status.CONCLUDED);
		Transport transport5 = new Transport(null, LocalDate.of(2022, 03, 17), 12458, "Itu - SP", "Curitiba - PR", new BigDecimal(21000.31), truck, Status.CONCLUDED);
		Transport transport6 = new Transport(null, LocalDate.of(2019, 05, 18), 12458, "Vargem Grande do Sul - SP", "Ribeirão Preto - SP", new BigDecimal(32500.09), truck, Status.CONCLUDED);
